...
## Python Version
- Target: Python 3.11+ (use features available in 3.11)
- Configured in pyproject.toml: `target-version = "py311"`
...
- Use `X | None` for nullable types (Python 3.10+ union syntax)
